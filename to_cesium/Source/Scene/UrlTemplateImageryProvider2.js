...
import GeographicProjection from "../../../cesium/Source/Core/GeographicProjection.js";
...
import ImageryProvider from "../../../cesium/Source/Scene/ImageryProvider.js";
...
/**
 * @typedef {Object} UrlTemplateImageryProvider2.ConstructorOptions
 *
 * Initialization options for the UrlTemplateImageryProvider2 constructor
 *
 ...
 *                 {@link UrlTemplateImageryProvider2#pickFeatures} will immediately returned undefined, indicating no
 ...
 *                                 specific location when {@link UrlTemplateImageryProvider2#pickFeatures} is invoked.  If this
 *                                 parameter is not specified, feature picking is disabled.
 * @property {Boolean} [enablePickFeatures=true] If true, {@link UrlTemplateImageryProvider2#pickFeatures} will
 *        request the <code>pickFeaturesUrl</code> and attempt to interpret the features included in the response.  If false,
 *        {@link UrlTemplateImageryProvider2#pickFeatures} will immediately return undefined (indicating no pickable
 ...
 *
 * @alias UrlTemplateImageryProvider2
 * @constructor
 *
 * @param {UrlTemplateImageryProvider2.ConstructorOptions} options Object describing initialization options
 *
 * @example
 * // Access Natural Earth II imagery, which uses a TMS tiling scheme and Geographic (EPSG:4326) project
 * var tms = new Cesium.UrlTemplateImageryProvider2({
 ...
 * var positron = new Cesium.UrlTemplateImageryProvider2({
 *     url : 'http://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png',
 *     credit : 'Map tiles by CartoDB, under CC BY 3.0. Data by OpenStreetMap, under ODbL.'
 * });
 * // Access a Web Map Service (WMS) server.
 * var wms = new Cesium.UrlTemplateImageryProvider2({
 ...
 * var custom = new Cesium.UrlTemplateImageryProvider2({
 ...
 */
function UrlTemplateImageryProvider2(options) {
  ...
  /**
   * Gets or sets a value indicating whether feature picking is enabled.  If true, {@link UrlTemplateImageryProvider2#pickFeatures} will
...
Object.defineProperties(UrlTemplateImageryProvider2.prototype, {
  /**
   ...
   *  <li> <code>{height}</code>: The height of each tile in pixels.</li>
   * </ul>
   * @memberof UrlTemplateImageryProvider2.prototype
   * @type {String}
   * @readonly
   */
  url: {
   ...
   * {@link UrlTemplateImageryProvider2#pickFeatures} will immediately return undefined, indicating no
   * features picked.  The URL template supports all of the keywords supported by the
   * {@link UrlTemplateImageryProvider2#url} property, plus the following:
   * <ul>
   *     <li><code>{i}</code>: The pixel column (horizontal coordinate) of the picked position, where the Westernmost pixel is 0.</li>
   *     <li><code>{j}</code>: The pixel row (vertical coordinate) of the picked position, where the Northernmost pixel is 0.</li>
   *     <li><code>{reverseI}</code>: The pixel column (horizontal coordinate) of the picked position, where the Easternmost pixel is 0.</li>
   ...
   * not be called before {@link UrlTemplateImageryProvider2#ready} returns true.
   * @memberof UrlTemplateImageryProvider2.prototype
   * @type {Number}
   * @readonly
   * @default 256
   ...
   * This function should not be called before {@link UrlTemplateImageryProvider2#ready} returns true.
   * @memberof UrlTemplateImageryProvider2.prototype
   * @type {Number|undefined}
   * @readonly
   * @default undefined
   ...
   * the source of the imagery.  This function should not be called before {@link UrlTemplateImageryProvider2#ready} returns true.
   * @memberof UrlTemplateImageryProvider2.prototype
   * @type {Credit}
   * @readonly
   * @default undefined
 ...
 *
 * @param {Promise.<Object>|Object} options Any of the options that may be passed to the {@link UrlTemplateImageryProvider2} constructor.
 */
UrlTemplateImageryProvider2.prototype.reinitialize = function (options) {
  var that = this;
 ...
 */
UrlTemplateImageryProvider2.prototype.getTileCredits = function (x, y, level) {
  //>>includeStart('debug', pragmas.debug);
  if (!this.ready) {
    throw new DeveloperError(
 ...
 */
UrlTemplateImageryProvider2.prototype.requestImage = function (
  x,
  y,
  level,
  request
 ...
 */
UrlTemplateImageryProvider2.prototype.pickFeatures = function (
  x,
  y,
  level,
  longitude,
...
export default UrlTemplateImageryProvider2;
