...
/**
 * @typedef {Object} TileCoordinatesImageryProvider2.ConstructorOptions
 *
 * Initialization options for the TileCoordinatesImageryProvider2 constructor
 *
 ...
 *
 * @alias TileCoordinatesImageryProvider2
 * @constructor
 *
 * @param {TileCoordinatesImageryProvider2.ConstructorOptions} [options] Object describing initialization options
 */
function TileCoordinatesImageryProvider2(options) {
...
Object.defineProperties(TileCoordinatesImageryProvider2.prototype, {
  /**
   * Gets the proxy used by this provider.
   * @memberof TileCoordinatesImageryProvider2.prototype
   * @type {Proxy}
   * @readonly
   */
  proxy: {
   ...
   * not be called before {@link TileCoordinatesImageryProvider2#ready} returns true.
   * @memberof TileCoordinatesImageryProvider2.prototype
   * @type {Number}
   * @readonly
   */
   ...
   * the source of the imagery.  This function should not be called before {@link TileCoordinatesImageryProvider2#ready} returns true.
   * @memberof TileCoordinatesImageryProvider2.prototype
   * @type {Credit}
   * @readonly
   */
 ...
 */
TileCoordinatesImageryProvider2.prototype.getTileCredits = function (
  x,
  y,
  level
) {
 ...
 */
TileCoordinatesImageryProvider2.prototype.requestImage = function (
  x,
  y,
  level,
  request
 ...
 */
TileCoordinatesImageryProvider2.prototype.pickFeatures = function (
  x,
  y,
  level,
  longitude,
...
export default TileCoordinatesImageryProvider2;